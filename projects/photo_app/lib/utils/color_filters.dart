...
class CreamFilter extends ColorFilter {
  CreamFilter() : super(name: "Cream") {
...
// Maven: darkens images, increases shadows, and adds a slightly yellow tint overall
