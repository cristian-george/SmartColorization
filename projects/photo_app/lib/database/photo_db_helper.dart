...
const columnOriginalImagePath = 'originalImagePath';
const columnProcessedImagePath = 'processedImagePath';
...
class PhotoDbHelper {
  ...
  Future<void> _createTable() async => await database.execute('''
    create table if not exists $tablePhoto (
      ...
      $columnProcessedImagePath text not null,
  ...
  Future<int> deletePhotos() async => await database.delete(tablePhoto);
}
