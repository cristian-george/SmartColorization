...
from utils import load_image, convert_h5_to_tflite
...
def h5_to_tflite(h5_model_path='models/celebA_checkpoints/colorization_model_celebA.h5',
                 tflite_model_path='models/tflite/colorization_model_celebA.tflite'):
